...
// prod urls
const urls = {
  vendorLogin: `https://vendorlogin.auth.us-east-1.amazoncognito.com/login?client_id=7ohma3vpdlg9fi1bi6uq078g49&response_type=token&scope=aws.cognito.signin.user.admin+email+openid+phone+profile&redirect_uri=https://cmpe282.terasurfer.com/vendor`,
